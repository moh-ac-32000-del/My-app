...
export function SplashView() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <Text style={[styles.title, { color: colors.foreground }]}>{translate('appName')}</Text>
      <Text style={[styles.subtitle, { color: colors.mutedForeground }]}>{translate('appSubtitle')}</Text>
